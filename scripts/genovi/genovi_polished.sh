...
#SBATCH --job-name=genovi_polished
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
FILE=/gpfs01/share/BioinfMSc/life4136_2526/rotation1/group5/annotations/polished/PROKKA_02042026.gbk

genovi -t 16 -i $FILE -s complete -o genovi_polished
