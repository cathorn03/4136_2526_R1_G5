...
genovi \
  -i /gpfs01/share/BioinfMSc/life4136_2526/rotation1/group5/prokka/long/PROKKA_01302026.gbk \
  -s draft \
  -cu \
  -o /gpfs01/share/BioinfMSc/life4136_2526/rotation1/group5/genovi/genovi_long
